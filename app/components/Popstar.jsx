...
export default class Popstar extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
      <Exhibit title={'Popstar—Airbnb for Commercial Real Estate'} type={'TYPE'} typeButtons={typeButtons} roleButtons={roleButtons} techButtons={techButtons} exhibitImage={exhibitImage} projectHeadline={projectHeadline} projectDetails={projectDetails} />
      </div>
